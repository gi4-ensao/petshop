            ...
            <a href="#"><img src="images/de.gif" alt="" title="" border="0" /></a>
              ...
              <div class="cart">
                  ...
                  <div class="home_cart_content">
                  	 <c:choose>
						<c:when test="${sessionScope.card != null }">${sessionScope.card.getAddedToCardProducts().size() } x items | <span class="red">TOTAL: ${ sessionScope.card.getTotalPrice()} $</span></c:when>
						<c:otherwise>0  x items | <span class="red">TOTAL:0$</c:otherwise>
	    			</c:choose>
                   
                   
                  </div>
                  <a href="card.do" class="view_cart">view cart</a>
              </div>
